PROGRAM Advent Of Code 2021 day 1 part 2

padding for checking the 3 previous measurements and initial 0 >>>>>>
...
MEMORY LAYOUT: acc read helper lfCheck
  ...
  < go to acc
  <<<<<< go 3 numbers back for next step

  now we should have all numbers in memory separated by 0

COUNT NUMBER OF INCREASES
MEMORY LAYOUT: (3 steps back) 0 ??? 0 ??? 0 number prev helper/0 1 0 result

if 3 steps back measurement [
